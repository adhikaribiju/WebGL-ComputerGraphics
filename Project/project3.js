let radius = 0.0; // Increased radius to make the sphere bigger
let stacks = 30;
let slices = 30;
let vertices = [];
let indices = [];
...
function main() {
    ...
    // Adjusted camera position to accommodate larger objects
    viewMatrix[14] = -6.0; // Move camera back along Z-axis
    ...
    gl.clearColor(1.0, 1.0, 1.0, 1.0); // White background as in your original cube code
