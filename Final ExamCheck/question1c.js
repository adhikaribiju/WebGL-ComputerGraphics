...
var angleY = 0;
var rotationSpeed = 0.01; // Default rotation speed
...
//     var colorvec = [0.81, 0.18, 0.18, 1.0]; // #CF2F2E color for borders
...
function animate() {
    angleY += rotationSpeed; // Increment angleY for right to left rotation
    ...
    gl.uniformMatrix4fv(u_transformLoc, false, transformationMatrix);
        ...
        speedSlider.addEventListener("input", function() {
            rotationSpeed = speedSlider.value / 1000;
        });
